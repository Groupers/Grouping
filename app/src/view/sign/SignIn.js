            ...
            >
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <View style={styles.inner} >
                        ...
                        <Picker style={{ height: 25, width: 120,color:COLORS.FONT_GRAY}} mode={"dropdown"}
                        ...
                        <View style={styles.bottomContainer}>
                            ...
                            <Text style={styles.signupText} onPress={this.signUpButtonClicked.bind(this)}>Sign up</Text>
