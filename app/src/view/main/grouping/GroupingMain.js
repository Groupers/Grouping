...
import GroupingAddressSearch from "./GroupingAddressSearch";
import GroupingKeywordSearch from "./GroupingKeywordSearch";
...
class GroupingMain extends Component {
  ...
  render() {
    ...
    if (
      ...
      GROUPING_VIEW_STATUS.ADDRESS_SEARCH
    ) {
      view = <GroupingAddressSearch />;
    } else if (
      this.props.groupingStore.groupingViewStatus ===
      GROUPING_VIEW_STATUS.KEYWORD_SEARCH
    ) {
      view = <GroupingKeywordSearch />;
    }
