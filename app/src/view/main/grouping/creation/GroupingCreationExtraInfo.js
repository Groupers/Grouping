...
class GroupingCreationExtraInfo extends Component {
	...
	allGenderButtonStyle() {
		return {
			...
			backgroundColor:
				this.props.groupingCreationMainStore.groupingGender === GENDER.ALL
					? '#000'
					: '#fff',
		};
	}
	...
	maleGenderButtonStyle() {
		return {
			...
			backgroundColor:
				this.props.groupingCreationMainStore.groupingGender === GENDER.MALE
					? '#000'
					: '#fff',
		};
	}
	...
	femaleGenderButtonStyle() {
		return {
			...
			backgroundColor:
				this.props.groupingCreationMainStore.groupingGender === GENDER.FEMALE
					? '#000'
					: '#fff',
		};
	}
							...
							<View style={styles.genderContainer}>
								...
								<View style={styles.genderSelectionView}>
									<View style={this.allGenderButtonStyle()}>
										<Button
											title="ALL"
											onPress={() => this.onGenderSelected(GENDER.ALL)}
										/>
									</View>
									<View style={this.maleGenderButtonStyle()}>
										<Button
											title="MALE"
											onPress={() => this.onGenderSelected(GENDER.MALE)}
										/>
									</View>
									<View style={this.femaleGenderButtonStyle()}>
										<Button
											title="FEMALE"
											onPress={() => this.onGenderSelected(GENDER.FEMALE)}
										/>
									</View>
								</View>
							</View>
